...
### Scientific Correction in the Pre-AI Era

https://haqueshenas.github.io/lesson-one/scientific-correction-pre-ai/

---

# Licensing Summary

This package contains both software and non-software materials.

### 1. Software and Source Code

Code files located in the **code** directory are licensed under the MIT License.

See:

LICENSE-CODE.txt

### 2. Data, Figures, Documents, and Other Materials

Datasets, CSV files, figures, graphical outputs, PDF files, documentation, and all other supplementary materials are licensed under the Creative Commons Attribution 4.0 International License (CC BY 4.0).
